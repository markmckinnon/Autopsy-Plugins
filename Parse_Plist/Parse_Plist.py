# This python autopsy module will parse any plist and convert it to a SQLite databases
# and then import the information into the extracted content.  The executable program is 
# a modified version of the python script plist2db.py from Adrian Leong (cheeky4n6monkey@gmail.com)
# plist2db.py.
#
...
# Parse plist file a sqlite database.
# Sept 2016
# 
# Comments 
...
class ParsePlists2DBDelRecIngestModuleFactory(IngestModuleFactoryAdapter):

    moduleName = "Parse Plists"
    
    def getModuleDisplayName(self):
        return self.moduleName
    
    def getModuleDescription(self):
        return "Parse Plist Files"
    ...
    def createDataSourceIngestModule(self, ingestOptions):
        return ParsePlists2DBDelRecIngestModule(self.settings)


# Data Source-level ingest module.  One gets created per data source.
class ParsePlists2DBDelRecIngestModule(DataSourceIngestModule):

    _logger = Logger.getLogger(ParsePlists2DBDelRecIngestModuleFactory.moduleName)
